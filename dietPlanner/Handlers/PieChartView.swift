...
struct PieChartView_Previews: PreviewProvider {
    static var previews: some View {
        PieChartView(values: [1300, 32500, 2500, 500], colors: [Color.blue, Color.green, Color.orange,Color.red], names: ["Fats", "Proteins", "Calories","Carbs"], backgroundColor: Color(red: 21 / 255, green: 24 / 255, blue: 30 / 255, opacity: 1.0), innerRadiusFraction: 0.6)
    }
}
